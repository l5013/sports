...
<ol class="breadcrumb">
  ...
  <li class="active">场地添加页面</li>
</ol>

<div class="row">
		<div class="col-lg-11">
			<form id="msform" class="form-horizontal" action="${pageContext.request.contextPath }/Place/add.do" method="post" enctype="multipart/form-data">
				<fieldset>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-5">
				      <input type="text" name="openTime" class="form-control datepicker" placeholder="开放时间">
				    </div>
				  </div>
				  <div class="form-group">
				    <label for="closeTime" class="col-sm-2 control-label">关闭时间</label>
				    <div class="col-sm-5">
				      <input type="text" name="closeTime" class="form-control datepicker" placeholder="关闭时间">
				    </div>
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-5">
					    <div class="input-group">
					      ...
					      <input type="text" name="price" class="form-control" id="price" placeholder="价格" onkeyup="checkDecimal(this)">
					    </div>
				    </div>
				  </div>
				  <div class="form-group">
				    ...
				    <div class="col-sm-5">
				      <input type="text" name="quantity" class="form-control" id="quantity" placeholder="数量" btvd-type="required number" btvd-class='btvdclass'>
				    </div>
				  </div>
		       	   <div class="form-group">
				    <div class="col-sm-5">
